...
async def hello_world(client: Client, message: Message):
    mg = await edit_or_reply(
        message,
        " 💘 #𝐁ᴏʟᴀ 𝐓ʜᴀ...🤣🤣 #ᴊᴄʙ 𝐊ᴏ #ᴋʜᴏᴅɴᴀ 𝐀ᴜʀ #_Tᴏᴘᴘᴇʀs 𝐊ᴏ #ᴄʜʜᴏᴅɴᴀ 😎 𝐀ᴀᴄʜᴇ 𝐒ᴇ 𝐀ᴀᴛᴀ 𝐇ᴀɪ...👻 ",
    )


@Client.on_message(
    filters.me & (filters.command(["topper"], ".") | filters.regex("^topper "))
)
async def hello_world(client: Client, message: Message):
    mg = await edit_or_reply(message, "topper")
    await asyncio.sleep(0.3)
    await mg.edit("topper")
    ...
    await mg.edit("ᴛᴏᴘɪ")
    await asyncio.sleep(0.3)
    await mg.edit("👻 #_Tᴏᴘᴘᴇʀs 𝐎ᴘ💗𝐁ᴀᴋᴋɪ 𝐒ᴀʙ #𝐋ᴀɴᴅ 𝐊ɪ 𝐓ᴏᴘɪ💘")
...
async def hajqag(client: Client, message: Message):
    ...
    await message.edit("Calling ㅤ Tᴏᴘ Fɪɢʜᴛᴇʀs ➳ (𝐁ᴀᴀᴘ of telegram)......")
    animation_chars = [
        "`Connecting To Telegram #Tᴏᴘ_Fɪɢʜᴛᴇʀs_ʜᴇʟʟ`",
        "`Call Connected.`",
        "`Tᴏᴘ➳𝐅ᴛᴇʀ: Hello ʙᴏʟ ᴍᴄ. ᴋᴏɴ ʀᴀɴᴅɪ ᴋᴀ ᴘɪʟʟᴀ ʜᴀɪ ᴛᴜ...ʙsᴅᴋᴇ ᴋʏᴀ ᴋᴀᴀᴍ ʜᴀɪ ᴛᴇʀᴀ..?`",
        f"`Me:  ᴍᴇ ʜᴜɴ ᴛᴇʀᴀ` {DEFAULTUSER} ,`ᴍᴜᴛʜᴇ    Tᴏᴘ➳𝐌ɪɴᴅ 𝐆ᴀᴍᴇʀ🍃 ᴋɪ ɢᴀɴᴅ ᴍᴀʀɴɪ ʜᴀɪ..😁😁`",
        "`User Authorised.`",
        "`Calling ㅤ Tᴏᴘ➳𝐌ɪɴᴅ 𝐆ᴀᴍᴇʀ🍃`  `At +916969696969`",
        "`Private  Call Connected...`",
        "`Me: Hello ᴍᴄ, Tᴏᴘ➳𝐌ɪɴᴅ 𝐆ᴀᴍᴇʀ🍃...ᴛᴇʀɪ ᴍᴀ ᴋɪ ᴄʜᴜᴛ...🤣🤣😂.`",
        "ㅤ Tᴏᴘ➳𝐌ɪɴᴅ 𝐆ᴀᴍᴇʀ🍃 :ᴏᴋᴀʏ sɪʀ ʙᴜᴛ ᴘᴇʜʟᴇ #Tᴏᴘ_Fɪɢʜᴛᴇʀ ᴋᴀ ʙᴇᴛᴀ ᴋᴏɴ ʜᴀɪ ᴛᴜ?...😎`",
        f"`Me: ᴀʙᴇ ᴢʜᴀᴛᴜ, I Am` {DEFAULTUSER} ",
        "`ㅤ Tᴏᴘ➳𝐌ɪɴᴅ 𝐆ᴀᴍᴇʀ🍃 : ᴀʙᴇ ғᴀᴛᴇ ʜᴜʏᴇ ᴄᴏɴᴅᴀᴍ ᴋᴇ ɴᴀᴛɪᴊᴇ...🤣🤣\nʙsᴅᴋᴇ ɢʜᴀʀ ᴍᴇ ɢʜᴜsᴋᴇ ᴛᴇʀɪ ᴀᴍᴍᴀ ʙᴇʜᴇɴ ᴋᴀ ʀᴇᴘ ᴋᴀʀᴅᴜɴɢᴀ ᴢʜᴀᴛᴜ😜.`",
        "`Me: ᴀʙᴇ ʙsᴅᴋᴇ... ᴛᴇʟᴇɢʀᴀᴍ #Tᴏᴘ_Fɪɢʜᴛᴇʀ ᴋᴏ ᴄʜᴀʟᴀ ʀᴀʜᴀ ᴋɪ #Tᴏᴘ_Fɪɢʜᴛᴇʀ ᴛᴇʟᴇɢʀᴀᴍ ᴋᴏ ᴄʜᴀʟᴀ ʀᴀʜɪ...?😜.`",
        "`ㅤ Tᴏᴘ➳𝐌ɪɴᴅ 𝐆ᴀᴍᴇʀ🍃 : ʙᴇᴛᴇ...!! ɴᴀᴀ ᴊᴀᴍɪɴ ᴘᴇ ɴᴀ ᴀᴀsᴍᴀɴ ᴘᴇ...😉😉 ᴛᴇʀɪ ᴍᴀʏʏᴀ ᴋᴏ ᴄʜʜᴏᴅᴜɴɢᴀ ᴍᴇ #Tᴏᴘ_Fɪɢʜᴛᴇʀ_Gɪʀʟ ᴋᴇ ᴍᴀᴋᴋᴀɴ ᴘᴇ...🥵🥵.`",
        "`Me: ʙʜᴀɪ...ʏᴀᴀʀ ᴍᴇʀɪ ɢᴀᴀɴᴅ ᴍᴀʀᴏ ʙᴜᴛ ᴍᴜᴊʜᴇ ᴍᴀғ ᴋᴀʀᴏ...🤯`",
        "`ㅤ Tᴏᴘ➳𝐌ɪɴᴅ 𝐆ᴀᴍᴇʀ🍃 : ʜɪʜɪʜɪ... ʏᴇ ʜᴜɪ ɴᴀ ʙᴀᴀᴛ....😁😁\nᴄʜᴀʟ ᴀᴀʙ ᴀᴀᴘɴɪ ʀᴀɴᴅɪ ᴍᴀʏʏᴀ ᴋᴏ #Tᴏᴘ_Fɪɢʜᴛᴇʀ_Gɪʀʟ ᴋᴇ ᴠᴄ ᴘᴇ ʙᴜʟᴀ ᴋɪ ᴄʜᴜᴛ ᴅɪᴋʜᴀɴᴇ ᴋᴏ ʙᴏʟ😛😛.`",
        "`Me: ʙʜᴀɪ ᴘʟᴢ ɢᴀʟɪ ᴍᴛ ᴅᴏ😥.`",
        "`ㅤ Tᴏᴘ➳𝐌ɪɴᴅ 𝐆ᴀᴍᴇʀ🍃 : ᴛᴏ #Tᴏᴘ_Fɪɢʜᴛᴇʀ ᴋᴏ ʙᴀᴀᴘ ʙᴏʟ ᴀᴜʀ...ᴄʜᴀʟ ʙʜᴀɢ ʏᴀʜᴀ sᴇ ᴍᴄ..ʙsᴅᴋᴇ ᴋᴇ ᴘʜɪʀ ᴄᴀʟʟ ᴋɪʏᴀ ᴛᴏ #Tᴏᴘ_Fɪɢʜᴛᴇʀ ᴋɪ ᴠᴄ ᴘᴇ ᴛᴇʀɪ ᴍᴀʏʏᴀ ᴋᴏ ɴᴀɴɢᴀ ᴋᴀᴜɴɢ..🤣🤣  \n🙈𝐓ɢ 𝐏ᴇ 𝐑ᴇʜɴᴀ 𝐇ᴀɪ 𝐓ᴏ🧐Tᴏᴘ_Fɪɢʜᴛᴇʀ 𝐊ᴏ 𝐁ᴀᴀᴘ💞𝐁ᴏʟᴏ..🤪 @UncleChipssBot 👻 :)`",
        "`Private Call Disconnected....Tᴏᴘ➳𝐌ɪɴᴅ 𝐆ᴀᴍᴇʀ🍃 ɴᴇ ᴏᴘ ɢᴀɴᴅ ᴍᴀʀᴅɪ..🤣🤣🤣`",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
async def gagahkah(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "What The F",
        "What The F Brah",
        "[💘 #𝐁ᴏʟᴀ 𝐓ʜᴀ...🤣🤣 #ᴊᴄʙ 𝐊ᴏ #ᴋʜᴏᴅɴᴀ 𝐀ᴜʀ #Tᴏᴘ_Fɪɢʜᴛᴇʀ 𝐊ᴏ #ᴄʜʜᴏᴅɴᴀ 😎 𝐀ᴀᴄʜᴇ 𝐒ᴇ 𝐀ᴀᴛᴀ 𝐇ᴀɪ...👻](https://telegra.ph/file/f5b0e7f2bd95153968e87.jpg)",
    ]
    for i in animation_ttl:
...
async def gkahgagw(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "⬜⬜⬛⬜⬜\n⬜⬛⬜⬜⬜\n🔴⬜⬜⬜⬜",
        "🔴⬛⬛⬜⬜\n⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜",
        "⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜\n⬜  [👑 Sᴜᴘᴇʀ Tᴏᴘᴘᴇʀs Is Bᴇsᴛ 👑](https://github.com) ⬜\n⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜",
    ]
    if message.forward_from:
        return
...
async def gajjajay(client: Client, message: Message):
    ...
    await asyncio.sleep(0.2)
    await message.edit("#Tᴏᴘ_Fɪɢʜᴛᴇʀ")
    await asyncio.sleep(0.3)
    await message.edit("ArRivE")
    await asyncio.sleep(0.3)
    await message.edit("🔥🔥🔥")
    await asyncio.sleep(0.3)
    await message.edit("EVERyBOdy iZ GangSTur UNtIL #Tᴏᴘ_Fɪɢʜᴛᴇʀ ArRivE 🔥🔥🔥")
...
async def timer_blankx(client: Client, message: Message):
    txt = (
        message.text[10:]
        + "\n\n`Tesla Wireless Charging (beta) Started...\nDevice Detected: Nokia 16 Pro + Max\nBattery Percentage:` "
    )
    j = 10
    k = j
    for j in range(j):
...
async def kocok(client: Client, message: Message):
    ...
    await e.edit("ᴏʏᴇ ᴍᴄ...ʏᴇsᴇ ʜɪ ᴍᴜᴛʜ ᴍᴀʀᴜɴɢᴀ #Tᴏᴘ_Fɪɢʜᴛᴇʀ ᴋᴇ ʟᴀɴᴅ sᴇ ᴛᴇʀɪ ᴍᴀʏʏᴀ ᴋɪ ᴄʜᴜᴛ ᴍᴇ🤣")
...
async def hak(client: Client, message: Message):
    ...
    await asyncio.sleep(2)
    await message.edit_text(
        "Targeted Account Hacked...!\n\n ✅ File has been successfully uploaded to my server.\nTelegram @SuperToppers Database:\n`./DOWNLOADS/msgstore.db.crypt12`"
    )
...
async def awikwok(client: Client, message: Message):
    await edit_or_reply(
        ...
        "▄▀──█▄▄──────█─█▄▄\n"
        "─▄▄▄▀──▀▄───▄▄▄▀──▀▄\n"
        "─▀───────▀▀─▀───────▀▀\n`ʙʜᴀɢ ᴍᴄ😥😥.. #Sᴜᴘᴇʀ_Tᴏᴘᴘᴇʀs ᴡᴀʟᴇ ᴄʜᴏᴅɴᴇ ᴀᴀɢᴀʏᴇ.👻`",
    )
